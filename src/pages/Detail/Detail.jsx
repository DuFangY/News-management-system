    ...
    return (
        <div className="site-page-header-ghost-wrapper">
            <PageHeader
                ...
                subTitle={newsInfo.length === 0 ? '' : likeState ?
                    <span>
                        <span style={{ marginRight: '10px' }}>{newsInfo.category.title}</span>
                        <Icon component={HeartSvg} style={{ color: 'hotpink' }} onClick={like} />
                    </span> :
                    <span>
                        <span style={{ marginRight: '10px' }}>{newsInfo.category.title}</span>
                        <HeartTwoTone twoToneColor="#eb2f96" onClick={like} />
                    </span>}
            >
